...
export default function Home() {
  ...
  const getUserNFTBalance = async () => {
    try {
      ...
      console.log(`signerAddr: '`+signer.getAddress()+`'`)
  ...
  const getProviderOrSigner = async (needSigner = false) => {
    ...
    if (chainId !== 80001) {
      window.alert("Please switch to the Polygon Mumbai testnet network!");
      throw new Error("Err: Please switch to the Polygon Mumbai testnet  network");
    }
